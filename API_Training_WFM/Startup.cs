...
using API_Training_WFM.Services;
...
namespace API_Training_WFM
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.TryAddScoped<ISoftlocksService, SoftlocksService>();
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "API_Training_WFM", Version = "v1" });
            });
        }
