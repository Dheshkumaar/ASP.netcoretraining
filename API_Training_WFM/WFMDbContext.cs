...
namespace API_Training_WFM
{
    public class WFMDbContext : DbContext
    {
        ...
        private static void ConfigureModels(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Profiles>().Property(x => x.profile_name).IsRequired().HasMaxLength(50).HasColumnType("varchar");
            #endregion
            ...
            modelBuilder.Entity<Users>().Property(x => x.email).HasMaxLength(50).HasColumnType("varchar");
            #endregion
            ...
            modelBuilder.Entity<Employees>().HasOne(a => a.profile).WithMany(b => b.employees).HasForeignKey(c => c.ProfileId);
            #endregion
            ...
            modelBuilder.Entity<Softlocks>().Property(x => x.requestmessage).HasMaxLength(100).HasColumnType("varchar");
            ...
            modelBuilder.Entity<Softlocks>().Property(x => x.mgrstatuscomment).HasMaxLength(100).HasColumnType("varchar");
